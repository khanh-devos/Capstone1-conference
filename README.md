...
# 📖 [Capstone1-conference] <a name="about-project"></a>

**Captone1-conference** is my first capstone project that launches an eletric vehicles conference.  
...
Feel free to check the [issues page](https://github.com/khanh-devos/Capstone1-conference/issues).
